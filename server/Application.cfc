component {
	...
	this.assetBundleVersion = 41;  // see parent application.cfc


	public void function onApplicationStart()  {
		application.assetBundleVersion = 41;
		//_addChangeWatcher();
	}
...
// PRIVATE
	private void function _renderPage() {
		...
		var pageContent = buildRunner.getBuilder( "html" ).renderPageContent( page, docTree, true, {} );
