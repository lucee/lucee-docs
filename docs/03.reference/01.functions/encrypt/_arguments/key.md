...
- For all other algorithms, a key in the format used by the algorithm. For these algorithms, use the [[function-GenerateSecretKey]] function to generate the key.