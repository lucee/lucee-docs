...
The current folder stores reference documentation for the Lucee function, **GetSystemTotalMemory**. Contributions are very welcome and hopefully the information below should help you find your way around.
