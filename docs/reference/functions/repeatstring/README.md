...
The current folder stores reference documentation for the Lucee function, **repeatString**. Contributions are very welcome and hopefully the information below should help you find your way around.
