...
component accessors=true {
	...
	docsDir = ExpandPath( cwd & "/../../docs/" );

	property name="referenceDirectory"   default="#docsDir#reference/";
	...
	property name="functionReferenceUrl" default="#cwd#/resources/funclib.xml";
	property name="tagReferenceUrl"      default="#cwd#/resources/taglib.xml";
}