...
localStorage&&localStorage.setItem("lastSearch",s);var e,t,l=n(r=s);return t=(t=a.filter(function(e){var t,n,i,o,r=e.desc?e.desc:e.text,
a=e.text.length;for(i=0;i<a&&(n=r.substr(i).match(l.expr));i++)(!t||n[0].length<t[0].length)&&(t=n,o=e.text.substr(0,i)+e.text.substr(i).replace(
l.expr,l.replace));if(t)return e.score=t[0].length-s.length,e.highlight=o,!0})).sort(function(e,t){return e.score-t.score||e.text.length-t.text.length
}),(e={value:"https://duckduckgo.com/?q=site:docs.lucee.org "+encodeURIComponent(s),text:'Search all docs for "'+s+'"',
...
)+"</b>",t+1<n.length&&(i.replace+="$"+(2*t+2));return" "==e.charAt(e.length-1)&&(i+=" "),i};var c=function(e){return Mustache.render(
