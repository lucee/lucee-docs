...
e=arguments[s]))for(t in e)n=a[t],a!==(i=e[t])&&(c&&i&&(E.isPlainObject(i)||(o=Array.isArray(i)))?(o?(o=!1,r=n&&Array.isArray(n)?n:[]
):r=n&&E.isPlainObject(n)?n:{},a[t]=E.extend(c,r,i)):void 0!==i&&(a[t]=i));return a},E.extend({expando:"jQuery"+(d+Math.random()).replace(/\D/g,""),
...
}:function(e,t){var n,i=[],o=0,r=t.getElementsByTagName(e);if("*"===e){for(;n=r[o++];)1===n.nodeType&&i.push(n);return i}return r},
...
}});var j,O=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(E.fn.init=function(e,t,n){var i,o;if(!e)return this;if(n=n||j,"string"==typeof e){if(!(
...
this[i])?this[i](t[i]):this.attr(i,t[i]);return this}return(o=T.getElementById(i[2]))&&(this[0]=o,this.length=1),this}return e.nodeType?(this[0]=e,
this.length=1,this):y(e)?void 0!==n.ready?n.ready(e):e(E):E.makeArray(e,this)}).prototype=E.fn,j=E(T);var P=/^(?:parents|prev(?:Until|All))/,N={
children:!0,contents:!0,next:!0,prev:!0};function R(e,t){for(;(e=e[t])&&1!==e.nodeType;);return e}E.fn.extend({has:function(e){var t=E(e,this),
n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(E.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,o=this.length,r=[],
a="string"!=typeof e&&E(e);if(!$.test(e))for(;i<o;i++)for(n=this[i];n&&n!==t;n=n.parentNode)if(n.nodeType<11&&(a?-1<a.index(n
):1===n.nodeType&&E.find.matchesSelector(n,e))){r.push(n);break}return this.pushStack(1<r.length?E.uniqueSort(r):r)},index:function(e){
...
add:function(e,t){return this.pushStack(E.uniqueSort(E.merge(this.get(),E(e,t))))},addBack:function(e){return this.add(
...
);else if(void 0!==i&&(o=!0,y(i)||(a=!0),c&&(a?(t.call(e,i),t=null):(c=t,t=function(e,t,n){return c.call(E(e),n)})),t))for(;s<l;s++)t(e[s],n,
a?i:i.call(e[s],s,t(e[s],n)));return o?e:c?t.call(e):l?t(e[0],n):r},W=/^-ms-/,Q=/-([a-z])/g;function Y(e,t){return t.toUpperCase()}function U(e){
...
a=r&&r.attributes;if(void 0===n){if(this.length&&(o=K.get(r),1===r.nodeType&&!G.get(r,"hasDataAttrs"))){for(t=a.length;t--;)a[t]&&0===(i=a[t].name
).indexOf("data-")&&(i=U(i.slice(5)),ee(r,i,o[i]));G.set(r,"hasDataAttrs",!0)}return o}return"object"==typeof n?this.each(function(){K.set(this,n)}
):z(this,function(e){var t;if(r&&void 0===e)return void 0!==(t=K.get(r,n))?t:void 0!==(t=ee(r,n))?t:void 0;this.each(function(){K.set(this,n,e)})},
null,e,1<arguments.length,null,!0)},removeData:function(e){return this.each(function(){K.remove(this,e)})}}),E.extend({queue:function(e,t,n){var i;if(
e)return t=(t||"fx")+"queue",i=G.get(e,t),n&&(!i||Array.isArray(n)?i=G.access(e,t,E.makeArray(n)):i.push(n)),i||[]},dequeue:function(e,t){t=t||"fx"
;var n=E.queue(e,t),i=n.length,o=n.shift(),r=E._queueHooks(e,t);"inprogress"===o&&(o=n.shift(),i--),o&&("fx"===t&&n.unshift("inprogress"),
...
)return i=e.handleObj,E(e.delegateTarget).off(i.namespace?i.origType+"."+i.namespace:i.origType,i.selector,i.handler),this;if("object"==typeof e){for(
o in e)this.off(o,t,e[o]);return this}return!1!==t&&"function"!=typeof t||(n=t,t=void 0),!1===n&&(n=Te),this.each(function(){E.event.remove(this,e,n,t
...
tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return ae(n.elem,e,ne.exec(t),n),n}]},tweener:function(e,t){y(e)?(t=e,e=["*"]):e=e.match(I)
;for(var n,i=0,o=e.length;i<o;i++)n=e[i],ct.tweeners[n]=ct.tweeners[n]||[],ct.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var i,o,r,a,s,l,c,u,
...
,c=E.css(e,"position"),u=E(e),d={};"static"===c&&(e.style.position="relative"),s=u.offset(),r=E.css(e,"top"),l=E.css(e,"left"),(
"absolute"===c||"fixed"===c)&&-1<(r+l).indexOf("auto")?(a=(i=u.position()).top,o=i.left):(a=parseFloat(r)||0,o=parseFloat(l)||0),y(t)&&(t=t.call(e,n,
...
;o=0;for(;o<a.length;)i[a[o].identifier]&&s.push(a[o]),t&(B|H)&&delete i[a[o].identifier],o++;if(!s.length)return;return[S(r.concat(s),"identifier",!0
),s]}.call(this,e,t);n&&this.callback(this.manager,t,{pointers:n[0],changedPointers:n[1],pointerType:R,srcEvent:e})}});var be=2500;function we(){
...
n=!0,i=e.distance,o=e.direction,r=e.deltaX,a=e.deltaY;return o&t.direction||(t.direction&Y?(o=0===r?M:r<0?F:z,n=r!=this.pX,i=Math.abs(e.deltaX)):(
o=0===a?M:a<0?W:Q,n=a!=this.pY,i=Math.abs(e.deltaY))),e.direction=o,n&&i>t.threshold&&o&t.direction},attrTest:function(e){
...
):t.removeClass("control-highlight")}!function(e){"function"==typeof define&&define.amd?define("picker",["jquery"],e
):"object"==typeof exports?module.exports=e(require("jquery")):this.Picker=e(jQuery)}(function(m){function g(o,r,a,e){function s(){return g._.node(
"div",g._.node("div",g._.node("div",g._.node("div",f.component.nodes(u.open),h.box),h.wrap),h.frame),h.holder,'tabindex="-1"')}function l(e){
e.stopPropagation(),p.addClass(h.target),f.$root.addClass(h.focused),f.open()}function c(e){var t=e.keyCode,n=/^(8|46)$/.test(t);return 27==t?(
f.close(!0),!1):void((32==t||n||!u.open&&f.component.key[t])&&(e.preventDefault(),e.stopPropagation(),n?f.clear().close():f.open()))}if(!o)return g
;var u={id:o.id||"P"+Math.abs(~~(Math.random()*new Date))},d=a?m.extend(!0,{},a.defaults,e):e||{},h=m.extend({},g.klasses(),d.klass),p=m(o),
t=function(){return this.start()},f=t.prototype={constructor:t,$node:p,start:function(){return u&&u.start?f:(u.methods={},u.start=!0,u.open=!1,
u.type=o.type,o.autofocus=o==y(),o.readOnly=!d.editable,o.id=o.id||u.id,"text"!=o.type&&(o.type="text"),f.component=new a(f,d),f.$root=m(
'<div class="'+h.picker+'" id="'+o.id+'_root" />'),v(f.$root[0],"hidden",!0),f.$holder=m(s()).appendTo(f.$root),f.$holder.on({keydown:c,
"focus.toOpen":l,blur:function(){p.removeClass(h.target)},focusin:function(e){f.$root.removeClass(h.focused),e.stopPropagation()},
"mousedown click":function(e){var t=e.target;t!=f.$holder[0]&&(e.stopPropagation(),"mousedown"!=e.type||m(t).is(
...
)return o.value;if(e in f.component.item){if("string"==typeof t){var n=f.component.get(e);return n?g._.trigger(f.component.formats.toString,
f.component,[t,n]):""}return f.component.get(e)}},on:function(e,t,n){var i,o,r=m.isPlainObject(e),a=r?e:{};if(e)for(i in r||(a[e]=t),a)o=a[i],n&&(
...
t.prototype.create=function(e,t,n){var i;return(t=void 0===t?e:t)==-1/0||1/0==t?i=t:f.isPlainObject(t)&&v.isInteger(t.pick)?t=t.obj:f.isArray(t)?(
t=new Date(t[0],t[1],t[2]),t=v.isDate(t)?t:this.create().obj):t=v.isInteger(t)||v.isDate(t)?this.normalize(new Date(t),n):this.now(e,t,n),{
...
){for(l?(o=t.year,r=t.month,a=t.date):(o=+t[0],r=+t[1],a=+t[2]),n&&n.nav&&c&&c.month!==r&&(o=c.year,r=c.month),o=(i=new Date(o,r+(n&&n.nav?n.nav:0),1)
...
"webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(e){toastHide(6e3)})}),function(r){var a,e=r("base[href]"
).attr("href");a=e?e+"editor.html":"/editor.html",r.fn.tryCfLoader=function(){return this.each(function(){var e=r(this),t=e.next(),n=e.attr("id"),
i=e.data("script"),o=r(
'<iframe seamless="seamless" frameborder="0" src="'+a+"?script="+i+'" name="'+n+'" class="trycf-iframe" height="600" width="100%"></iframe>');e.after(
o),t.remove()})},r("script[data-trycf]").tryCfLoader()}(jQuery),function(t,n){"function"==typeof define&&define.amd?define("bloodhound",["jquery"],
function(e){return t.Bloodhound=n(e)}):"object"==typeof exports?module.exports=n(require("jquery")):t.Bloodhound=n(jQuery)}(this,function(p){
...
return b.fn.typeahead=e,this}}()}),function(s){var e,i,n,l,c,o=s("#lucee-docs-search-input");s(".search-link"),s(".search-container");e=function(){
setupSearchEngine(function(e){var t={source:e,displayKey:"display",limit:100,templates:{suggestion:a}};o.typeahead({hint:!0,highlight:!1,minLength:1},
...
"/assets/js/searchIndex.json",{method:"GET",success:function(e){c=e,t(function(e,t){t(l(e))})}})};var r="";l=function(a){
localStorage&&localStorage.setItem("lastSearch",a);var e,t,s=n(r=a);return t=(t=c.filter(function(e){var t,n,i,o,r=e.text.length;for(i=0;i<r&&(
n=e.text.substr(i).match(s.expr));i++)(!t||n[0].length<t[0].length)&&(t=n,o=e.text.substr(0,i)+e.text.substr(i).replace(s.expr,s.replace));if(t
)return e.score=t[0].length-a.length,e.highlight=o,!0})).sort(function(e,t){return e.score-t.score||e.text.length-t.text.length}),(e={
value:"https://duckduckgo.com/?q=site:docs.lucee.org "+encodeURIComponent(a),text:'Search all docs for "'+a+'"',
highlight:'<em>Search all docs for <strong>"'+a+'</strong>"</em>',score:1e6,icon:"search",type:""}).display=e.text,t.unshift(e),t},n=function(e){var t
,n=e.replace(/[\W]+/g,"").split(""),i={};for(i.expr=new RegExp("("+n.join(")(.*?)(")+")","i"),i.replace="",t=0;t<n.length;t++)i.replace+="<b>$"+(2*t+1
)+"</b>",t+1<n.length&&(i.replace+="$"+(2*t+2));return i};var a=function(e){return Mustache.render(
...
".menu-random").on("click",function(e){for(var t,n,i,o=document.location.pathname.toLowerCase(),r=o;r==o;)n=1,i=c.length,t=Math.floor(Math.random()*(
i-n+1))+n,r=c[t-1].value.toLowerCase();document.location=r})}(jQuery),function(e,t){"use strict";"function"==typeof define&&define.amd?define([],
