...
).attr("href");s=e?e+"editor.html":"/editor.html",a.fn.tryCfLoader=function(){return this.each(function(){var e=a(this),t=e.next(),n=e.attr("id"),
i=e.data("script"),o=s+"?script="+i+"&id="+e.attr("id"),r=a(
'<iframe seamless="seamless" frameborder="0" src="'+o+'" name="'+n+'" class="trycf-iframe" height="600" width="100%"></iframe>');e.after(r),t.remove()
})},a("script[data-trycf]").tryCfLoader()}(jQuery),function(t,n){"function"==typeof define&&define.amd?define("bloodhound",["jquery"],function(e){
return t.Bloodhound=n(e)}):"object"==typeof exports?module.exports=n(require("jquery")):t.Bloodhound=n(jQuery)}(this,function(p){var f=function(){
"use strict";return{isMsie:function(){return!!/(msie|trident)/i.test(navigator.userAgent)&&navigator.userAgent.match(/(msie |rv:)(\d+(.\d+)?)/i)[2]},
...
return p.isFunction(e)?e:function(){return String(e)}},defer:function(e){setTimeout(e,0)},debounce:function(o,r,a){var s,l;return function(){var e,t,
n=this,i=arguments;return e=function(){s=null,a||(l=o.apply(n,i))},t=a&&!s,clearTimeout(s),s=setTimeout(e,r),t&&(l=o.apply(n,i)),l}},
...
},noop:function(){}}}(),n=function(){"use strict";function e(e){return(e=f.toStr(e))?e.split(/\s+/):[]}function t(e){return(e=f.toStr(e))?e.split(
/\W+/):[]}function n(i){return function(){var e=[].slice.call(arguments,0);return function(t){var n=[];return f.each(e,function(e){n=n.concat(i(
f.toStr(t[e])))}),n}}}return{nonword:t,whitespace:e,obj:{nonword:n(t),whitespace:n(e)}}}(),i=function(){"use strict";function e(e){
...
localStorage&&localStorage.setItem("lastSearch",a);var e,t,s=n(r=a);return t=(t=c.filter(function(e){var t,n,i,o,r=e.desc.length;for(i=0;i<r&&(
n=e.desc.substr(i).match(s.expr));i++)(!t||n[0].length<t[0].length)&&(t=n,o=e.text.substr(0,i)+e.text.substr(i).replace(s.expr,s.replace));if(t
...
)+"</b>",t+1<n.length&&(i.replace+="$"+(2*t+2));return" "==e.charAt(e.length-1)&&(i+=" "),i};var a=function(e){return Mustache.render(
